...
**Tests**: The examples below include test tasks. Include the verification tasks needed by the feature specification and constitution; task ordering does not need to place tests before implementation, but required coverage must exist before story completion.
...
- [ ] T012 (If WebUI scope) Define JWT browser handling strategy (secure cookie or equivalent) and block persistent token storage
...
> **NOTE: Include the automated verification needed for story completion. These tasks do not have to appear before implementation tasks in the plan.**
...
- [ ] TXXX Clean code review: verify functions are small/focused, polymorphism used over complex conditionals,
  and any hot-path abstraction trade-offs are documented with profiling evidence
- [ ] TXXX Performance optimization across all stories
- [ ] TXXX [P] Additional unit tests (if requested) in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Threat-model documentation for security-sensitive features in `specs/[###-feature-name]/threat-model.md` and `docs/security-threat-model.md`
...
- Automated tests covering changed behavior MUST exist before the story is marked complete
...
- Ensure required verification coverage exists before story completion
