 ...
 */
    ...
    public:
         ...
         */
        multi_dim_map(const T_value& val) : m_value(val), m_has_value(true) {}
        multi_dim_map(T_value&& val) : m_value(std::move(val)), m_has_value(true) {}
        ...
        /**
         * @brief Emplace a new child or value
         * @param args Arguments to forward to std::map::emplace or to construct T_value
         */
