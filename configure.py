...
if __name__ == '__main__':
    ...
    if os.name == "nt":
        os.system(
            "cmake . -B ./cmake-build-debug -DCMAKE_TOOLCHAIN_FILE=cmake-build-debug/build/generators/conan_toolchain.cmake -DCMAKE_POLICY_DEFAULT_CMP0091=NEW -DCMAKE_BUILD_TYPE=Debug")
    else:
